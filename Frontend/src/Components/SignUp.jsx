    ...
    <div className='flex items-center w-full h-screen justify-center'>
        <div className='bg-gray-100 w-auto sm:h-80 h-[420px] rounded-xl shadow-lg border border-gray-500 flex sm:flex-row flex-col'>
            <div className='sm:w-[50%] w-full h-40 sm:h-full bg-green-600 text-white sm:rounded-tl-xl sm:rounded-bl-xl rounded-tr-xl rounded-tl-xl flex justify-center items-center flex-col '>
                <h1 className='text-2xl font-bold font-Roboto '>Sign Up</h1>
                <p className='text-lg mx-4'>Sign-Up to Explore More</p>
            </div>
            <div className='mt-10'>
                <form onSubmit={createUser} method='Post'>
                    ...
                    <p className='ml-4'>Already have an Account? <NavLink to='/Login' className='text-blue-500 hover:underline transition-all cursor-pointer'>Login</NavLink></p>
